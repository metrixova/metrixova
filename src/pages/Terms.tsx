  ...
  return (
    <div className="pt-32 pb-24 max-w-4xl mx-auto px-6">
      <motion.div
        ...
        <h1 className="text-4xl md:text-5xl font-display text-metrix-white mb-4">
          Terms and Conditions
        </h1>
        <p className="text-metrix-muted mb-8">Last updated: June 29, 2026</p>

        <div className="text-metrix-muted space-y-6 leading-relaxed">
          ...
          <h3 className="text-xl font-display text-metrix-white mt-6 mb-3">
            Interpretation
          </h3>
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li><strong>Website</strong> refers to Metrixova, accessible from <a href="https://metrixova.com/" target="_blank" rel="noopener noreferrer" className="text-metrix-crimson-bright hover:underline">https://metrixova.com/</a>.</li>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>By email: help@metrixova.com</li>
            <li>By visiting this page on our website: <a href="https://metrixova.com/" target="_blank" rel="noopener noreferrer" className="text-metrix-crimson-bright hover:underline">https://metrixova.com/</a></li>
            <li>By phone: +1 (310) 661-5248</li>
          </ul>
        </div>
      </motion.div>
    </div>);
